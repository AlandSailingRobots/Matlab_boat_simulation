...
%     psi = -3;  % angle of the wind
    ...
    gps_waypoints = [gps_absolute_waypoints.utm_x - gps_start_x ; gps_absolute_waypoints.utm_y - gps_start_y];
    % Sailing zone
    gps_absolute_sailingzone = load('sailing_zone.mat');
    gps_sailing_zone = [gps_absolute_sailingzone.utm_x - gps_start_x ; gps_absolute_sailingzone.utm_y - gps_start_y];
    % Obstacles
    gps_absolute_obstacles = load('obstacles.mat');
    gps_obstacles = [gps_absolute_obstacles.utm_x - gps_start_x ; gps_absolute_obstacles.utm_y - gps_start_y];
