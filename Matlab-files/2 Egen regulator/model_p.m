function dstate_dt = model_p(t,state,W,U)
...
Fr = p5*v ^2*sin(delta_r);             %Force of water on rudder
...
dstate_dt = [...
    ...
    omega;                              %theta_dot
    (Fs*sin(delta_s)-p11*Fr*sin(delta_r)-sign(v)*p2*v^2)/p9;                 %v_dot
