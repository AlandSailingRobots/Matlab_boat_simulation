path(path,'C:\matlab_sailing\Matlab-files\2 Egen regulator');
path(path,'C:\matlab_sailing\new');
path(path,'C:\matlab_sailing\GPS_POS');
path(path,'C:\matlab_sailing\collision_avoidance/Tools');
path(path,'C:\matlab_sailing\collision_avoidance/Sensors_and_OnboardTools');
path(path,'C:\matlab_sailing\collision_avoidance/Control');
